<template>
	<a-tree-select :style="{width:width}" :value="selectedValue" multiple
		:dropdown-style="{ maxHeight: '200px', overflow: 'auto' }" placeholder="请选择分类" allow-clear :max-tag-count="5"
